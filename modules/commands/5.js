...
"https://i.imgur.com/EaA7nKY.jpeg",
	 ...
	 var callback = () => api.sendMessage({body:`এই মেয়েদের ছবি দেখুন  \nউপলব্ধ ফটো সংখ্যা: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));	
