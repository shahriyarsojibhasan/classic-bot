...
"https://i.pixxxels.cc/jdM96PZ7/zZKvVvB.jpg",
  ...
  var money = data.money
      if(money < 0) api.sendMessage("আব্বে হালায় কি চাস ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 0})
   var callback = () => api.sendMessage({body:`এই ল সেক্সি মাইয়ার পিক \n» হলার পো লুচ্চা  ... «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
