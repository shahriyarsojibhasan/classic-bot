...
registerFont(__dirname + `/cache/CaviarDreams.ttf`, {
  ...
  return api.sendMessage({
    body: `সার্ভার তথ্য\n\nচিপ: ${chips}।\nপ্রসেসিং গতি: ${speed}MHz।\n\nমোট মেমরি: ${byte2mb(os.totalmem())}।\nব্যবহৃত: ${byte2mb(os.freemem) ())} (${(os.freemem() * 100 / os.totalmem()).toFixed()}%)।\n\nবট ${hours} ঘন্টা ${minutes} মিনিট ${সেকেন্ড পর্যন্ত চলছে } সেকেন্ড।\n\n❯ মোট ব্যবহারকারী: ${global.data.allUserID.length}\n❯ মোট গ্রুপ: ${global.data.allThreadID.length}\n❯ CPU ব্যবহার হচ্ছে: ${pidusage.cpu। toFixed(1)}%\n❯ র‌্যাম   ব্যবহার হচ্ছে: ${byte2mb(pidusage.memory)}\n❯ পিং: ${Date.now() - timeStart}ms\n❯ ক্যারেক্টার আইডি: ${id}\n ❯ অ্যাডমিন ফেসবুক:\nhttps://www.facebook.com/shahriyarsojibhasan`,
