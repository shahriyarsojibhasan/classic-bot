...
module.exports.run = async ({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) => {
  ...
  var callback = () => api.sendMessage({ body: `তুমার নুনু চুষে দেই 💦`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));
